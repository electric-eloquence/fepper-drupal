...
* You may install this as you would normally install a contributed Drupal 
  theme. See https://www.drupal.org/getting-started/install-contrib/themes 
...
* With that being known, it should also be known that this theme is included 
  within a fully configured Drupal 8 backend in the Fepper for Drupal project: 
  https://github.com/electric-eloquence/fepper-drupal
